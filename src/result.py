...
def display_emotion_graph(numOfCharacter, listOfCharacter, numOfPage, numOfEmotion, listOfEmotion, emotionVector):
    ...
    for num in range(0, numOfCharacter):
        ...
        for emo in range(0, numOfEmotion):
            plt.plot(x, emotionVector[num][emo][x], label=listOfEmotion[emo])
